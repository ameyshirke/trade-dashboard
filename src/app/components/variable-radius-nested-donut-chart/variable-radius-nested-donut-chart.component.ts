...
@Component({
  selector: 'app-variable-radius-nested-donut-chart',
  templateUrl: './variable-radius-nested-donut-chart.component.html',
  styleUrls: ['./variable-radius-nested-donut-chart.component.scss']
})

export class VariableRadiusNestedDonutChartComponent {
